	...
	<div class="container infinity-container">
		<div class="row">
			...
			<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 text-center infinity-form">
				...
				<!-- Form -->
				<form class="px-3" onSubmit="return validate(this)">
					<!-- Input Box -->
					<div class="form-input">
						<span><i class="fa fa-user"></i></span>
						<input type="text" name="" placeholder="Username" name="uname" required>
						 <span style="color:red" id="unameErr"></span>
					</div>
					<div class="form-input">
						<span><i class="fa fa-lock"></i></span>
						<input type="password" name="" placeholder="Password" name="pass" required>
