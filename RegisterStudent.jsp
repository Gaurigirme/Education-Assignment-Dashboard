...
<html lang="en" dir="ltr">
  <head>
	...
	<script type="text/javascript" src="RegistrationStud.js"></script>
      ...
      <form action="RegisterStudController" method="post" onsubmit="return validate(this)">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" placeholder="Enter your username" name="uname" maxlength="10" required>
          ...
          <div class="input-box">
            ...
            <input type="number" placeholder="Enter your Enrollment Number" name="enroll" required>
